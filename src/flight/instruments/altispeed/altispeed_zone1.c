...
#else
    Graphics_drawDigitMediumRoll(150, 262, currDigit, currRoll);
#endif
...
#else
            Graphics_drawDigitMediumRollSmall(150, y, currDigit, currRoll - 3); // -3 so we stay in sync with other digits
#endif
